...
if __name__ == "__main__":
	...
	top_mount_params = TopMountParams(plate_length=plate_parameters.length_mm, plate_width=plate_parameters.width_mm, plate_margin=plate_parameters.margin_mm, wall_thickness=thickness, height=19.65, plate=plate)
